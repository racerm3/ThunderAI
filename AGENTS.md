# ThunderAI - Codex Guide

## Project Overview
ThunderAI is a **Thunderbird WebExtension (Manifest V2)** that integrates multiple AI providers (ChatGPT Web, OpenAI API, Google Gemini, Codex/Anthropic, Ollama, and OpenAI-compatible APIs) directly into the Thunderbird email client.
...
7. **Keep spec files up to date:** When making code changes that affect a subsystem described in Codex-spec/, update the relevant spec file to reflect the new behavior. Read the spec before modifying, update it after.
...
For detailed documentation see [`Codex-spec/`](Codex-spec/):

- [01-architecture.md](Codex-spec/01-architecture.md) — Module structure and data flow
- [02-prompts.md](Codex-spec/02-prompts.md) — Prompt system (types, actions, properties)
- [03-placeholders.md](Codex-spec/03-placeholders.md) — Placeholder system
- [04-api-integrations.md](Codex-spec/04-api-integrations.md) — AI provider integrations
- [05-options.md](Codex-spec/05-options.md) — Settings and preferences system
- [06-localization.md](Codex-spec/06-localization.md) — i18n rules and workflow
- [99-thunderbird-team-spec.md](Codex-spec/99-thunderbird-team-spec.md) — Thunderbird WebExtensions development guidelines (API usage, experiments, review requirements)
